CREATE TABLE "germline_cnv" (
	"CNV.ID" INTEGER UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"Sample" VARCHAR(255),
	"Correlation" FLOAT,
	"N.comp" INTEGER,
	"N.exons" INTEGER,
...
CREATE TABLE "Normal_final_vcf" (
	"#CHROM" INTEGER UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"POS" INTEGER,
	"ID" CHAR(1),
	"REF" VARCHAR(255),
	"ALT" VARCHAR(255),
...
CREATE TABLE "unstable_bed" (
	"chr" INTEGER UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"start" INTEGER,
	"end" INTEGER,
